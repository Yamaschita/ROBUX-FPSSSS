...
import { Shape, Cuboid, Ball, Capsule, Voxels, TriMesh, Polyline, Heightfield, Compound, Segment, Triangle, RoundTriangle, RoundCuboid, 
// #if DIM3
...
export class ColliderDesc {
     ...
     */
    static convexDecomposition(vertices, indices, params) {
        let rawShape;
        if (params) {
            // Convert TypeScript params to Rust params
            const rawParams = new RawVHACDParameters();
            if (params.alpha !== undefined)
                rawParams.alpha = params.alpha;
            if (params.beta !== undefined)
                rawParams.beta = params.beta;
